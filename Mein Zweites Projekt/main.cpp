...
int main()
{
    ...
    zahl++; // Postfix Inkrement (zahl = 6) --> 5 wird �bergeben, danach hochgez�hlt
    ++zahl; // Pr�fix Inkrement (zahl = 7) --> erst hochgez�hlt, danach wird 7 �bergeben
    zahl--; // Pr�fix Dekrement (zahl = 6) --> 7 wird �bergeben, danach runtergez�hlt
    --zahl; // Pr�fix Dekrement (zahl = 5) --> erst runtergez�hlt, danach wird 5 �bergeben
    */
    int n = 4;
